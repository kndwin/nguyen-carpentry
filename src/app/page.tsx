...
function Hero() {
  return (
    <section className="body-font sm:min-h-screen flex items-center">
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-14">
      <div className="max-w-prose">
        <h2 className="title-font sm:text-6xl text-4xl mb-4 font-bold max-w-prose">
